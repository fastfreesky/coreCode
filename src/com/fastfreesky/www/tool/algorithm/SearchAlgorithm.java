package com.fastfreesky.www.tool.algorithm;
...
public class SearchAlgorithm {
	...
	public static int findLongInArea(Long[] srcArrayStart, Long[] srcArrayEnd,
			Long des) {
	...
	public static int findLongInArea(Long[] srcArrayStart, Long des) {

		return binarySearch(srcArrayStart, des);
	}
