package com.fastfreesky.www.area.ip;

import com.fastfreesky.www.area.impl.FindInAreaFromLong;
import com.fastfreesky.www.area.ip.classtype.IpValue;
import com.fastfreesky.www.tool.ip.Ip;
import com.fastfreesky.www.tool.time.TimeDiff;

public class ParseIp extends FindInAreaFromLong<IpValue<String>> {
	...
	public IpValue<String> getIp(String ip) {
		return get(Ip.ipToLong(ip), true);
	}
